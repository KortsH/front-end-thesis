...
export default function Home() {
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white dark:bg-gray-900 transition-colors">
      ...
      <main className="flex-1 flex flex-col items-center justify-center px-6 py-16 text-center mt-8">
        ...
        <div className="mt-8 w-full max-w-4xl bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-700 rounded-2xl p-8 shadow-lg transition-transform transform hover:scale-[1.01]">
          <Explanation />
        </div>
